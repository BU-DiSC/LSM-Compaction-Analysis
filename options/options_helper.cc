...
std::map<CompactionPri, std::string> OptionsHelper::compaction_pri_to_string = {
    ...
    {kFADE, "kFADE"}, // !YBS-aug17-XX!
    {kRoundRobin, "kRoundRobin"}, // !YBS-sep06-XX! 
    {kMinOverlappingGrandparent, "kMinOverlappingGrandparent"}, // !YBS-sep07-XX! 
    {kFullLevel, "kFullLevel"}}; // !YBS-sep08-XX! };
