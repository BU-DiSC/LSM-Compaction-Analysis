 ...
 public:
  ...
  static jbyte toJavaCompactionPriority(
    ...
    switch(compaction_priority) {
      ...
      case ROCKSDB_NAMESPACE::CompactionPri::kMinOverlappingRatio:
        return 0x3;
      case ROCKSDB_NAMESPACE::CompactionPri::kFADE: // !YBS-aug17-XX!
        return 0x4; // !YBS-aug17-XX!
      case ROCKSDB_NAMESPACE::CompactionPri::kRoundRobin: // !YBS-sep06-XX!
        return 0x5; // !YBS-sep06-XX!
      case ROCKSDB_NAMESPACE::CompactionPri::kMinOverlappingGrandparent: // !YBS-sep07-XX!
        return 0x6; // !YBS-sep07-XX!
      case ROCKSDB_NAMESPACE::CompactionPri::kFullLevel: // !YBS-sep08-XX!
        return 0x7; // !YBS-sep08-XX!
      default:
  ...
  static ROCKSDB_NAMESPACE::CompactionPri toCppCompactionPriority(
    ...
    switch(jcompaction_priority) {
      ...
      case 0x4: // !YBS-aug17-XX!
        return ROCKSDB_NAMESPACE::CompactionPri::kFADE; // !YBS-aug17-XX!
      case 0x5: // !YBS-sep06-XX!
        return ROCKSDB_NAMESPACE::CompactionPri::kRoundRobin; // !YBS-sep06-XX!
      case 0x6: // !YBS-sep07-XX!
        return ROCKSDB_NAMESPACE::CompactionPri::kMinOverlappingGrandparent; // !YBS-sep07-XX!
      case 0x7: // !YBS-sep08-XX!
        return ROCKSDB_NAMESPACE::CompactionPri::kFullLevel; // !YBS-sep08-XX!
      default:
        // undefined/default
        return ROCKSDB_NAMESPACE::CompactionPri::kByCompensatedSize;
    }
